...
/*   Updated: 2024/04/12 15:35:57 by aurban           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Fixed::Fixed(const int value){this->_value = value << _bits;}
...
const Fixed	Fixed::abs(const Fixed &n){
	return n.toFloat() < 0 ? Fixed(-n.toFloat()) : n;
}
